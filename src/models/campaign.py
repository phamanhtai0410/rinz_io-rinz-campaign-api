...
class CampaignModel(BaseMG):
    ...
    total_supply = fields.IntegerField(blank=True, default=0)
    current_sell = fields.IntegerField(blank=True, default=0)
    total_raise = fields.FloatField(blank=True, default=0)
